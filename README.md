...
O projeto com o codinome _commerce_. Nesse projeto, foi praticado todos os conceitos de **MongoDB** já ensinados até aqui.

Para esse projeto, escolhemos um dataset bem menor do que o **dataFlights**, mas isso não vai impediu a aplicação de tudo o que foi visto até aqui, combinando os conhecimentos deste bloco e do anterior.
...
Então vamos nesse banco de dados "saboroso"! 😉
